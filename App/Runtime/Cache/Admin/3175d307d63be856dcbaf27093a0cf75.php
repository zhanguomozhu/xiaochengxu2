...
<button type="button" tooltip="添加类型" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo U('Admin/Type/add');?>'"> <i class="fa fa-plus"></i> 添加类型
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($types)): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td align="center" style="width: 20%;">
                                    <a href="<?php echo U('Admin/Attribute/index',array('type_id'=>$vo['id']));?>" class="btn btn-purple btn-sm shiny">
                                        <i class="fa fa-tasks"></i>属性列表
                                    </a>
                                    <a href="<?php echo U('Admin/Type/edit',array('id'=>$vo['id']));?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="confirmJump('确实要删除吗', '<?php echo U('Admin/Type/del',array('id'=>$vo['id']));?>')" class="btn btn-danger btn-sm shiny">
