...
<button type="button" tooltip="添加图片" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo U('Admin/Banner/add');?>'"> <i class="fa fa-plus"></i> 添加图片
</button>
<div class="row">
        ...
        <div class="widget">
            <div class="widget-body">
                ...
                <div class="widget-body bordered-left bordered-warning">
                    <form class="form-inline" role="form" action="<?php echo U('Admin/Banner/index');?>" method="post">
                        <div class="form-group">
                            <select name="type">
                                <option value="">推荐位</option>
                                <option value="1" <?php if(I('post.type') == 1): ?>selected<?php endif; ?>>头部轮播图</option>
                                <option value="2" <?php if(I('post.type') == 2): ?>selected<?php endif; ?>>中部广告位</option>
                                <option value="3" <?php if(I('post.type') == 3): ?>selected<?php endif; ?>>底部广告位</option>
                            </select>
                        </div>
                ...
                <div class="flip-scroll">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($banners)): $i = 0; $__LIST__ = $banners;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td align="center" style="width: 5%;">
                                    <?php echo (levelstyle($vo["type"],array('头部轮播图','中部广告位','底部广告位'))); ?>
                                </td>
                                <td align="center" style="width: 5%;">
                                    <?php echo (status($vo["status"],U('Admin/Banner/editStatus',array('id'=>$vo['id'],'status'=>$vo["status"]?0:1),''))); ?>
                                </td>
                                <td align="center" style="width: 10%;"><?php echo (date("Y-m-d H:i:s",$vo["create_time"])); ?></td>
                                
                                <td align="center" style="width: 10%;">
                                    <a href="<?php echo U('Admin/Banner/edit',array('id'=>$vo['id']));?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="confirmJump('确实要删除吗', '<?php echo U('Admin/Banner/del',array('id'=>$vo['id']));?>')" class="btn btn-danger btn-sm shiny">
