            ...
            <div class="widget-body">
                ...
                <form action="" method="post">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                        <?php if(is_array($confs)): $i = 0; $__LIST__ = $confs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td align="center" style="width: 10%;"><?php echo (levelstyle($vo["type"],array('单行文本','多行文本','单选按钮','复选按钮','下拉菜单','上传按钮','未知类型'))); ?>
                                </td>
                                <td align="center" style="width: 20%;">
                                    <a href="<?php echo U('Admin/Conf/edit',array('id'=>$vo['id']));?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="confirmJump('确实要删除吗', '<?php echo U('Admin/Conf/del',array('id'=>$vo['id']));?>')" class="btn btn-danger btn-sm shiny">
