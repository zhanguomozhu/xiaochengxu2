...
<!-- 引入html -->
<div id="upload-5a582956a6b8f" class="xb-uploader">
    <div class="queueList">
...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        pick: {
            id: "#upload-5a582956a6b8f .filePicker",
            label: '点击选择文件',
            multiple : true
        },
        dnd: "#upload-5a582956a6b8f .queueList",
        paste: document.body,
        // accept: {
        //     title: 'Images',
    ...
    // 添加“添加文件”的按钮，
    uploader.addButton({
       id: "#upload-5a582956a6b8f .filePicker2",
       label: '继续添加'
    });
    ...
    function updateStatus() {
        ...
        if ( state === 'ready' ) {
            ...
            if (fileCount==stats.successNum && stats.successNum!=0) {
                $('#upload-5a582956a6b8f .webuploader-element-invisible').remove();
            }
        }
    ...
    function setState( val ) {
        ...
        switch ( state ) {
            ...
            case 'ready':
                ...
                $( "#upload-5a582956a6b8f .filePicker2" ).removeClass( 'element-invisible');
            ...
            case 'uploading':
                $( "#upload-5a582956a6b8f .filePicker2" ).addClass( 'element-invisible' );
                $progress.show();
                $upload.text( '暂停上传' );
                break;
