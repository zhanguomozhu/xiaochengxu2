                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($products)): $i = 0; $__LIST__ = $products;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td align="center" style="width: 15%;">
                                    <a href="<?php echo U('Admin/Product/editStatus',array('id'=>$vo['id'],'is_del'=>$vo['is_del']?0:1));?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 还原
                                    </a>
                                    <a href="#" onClick="confirmJump('确实要删除吗', '<?php echo U('Admin/Product/del',array('id'=>$vo['id']));?>')" class="btn btn-danger btn-sm shiny">
