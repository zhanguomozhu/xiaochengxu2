                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo U('Index/Index/index');?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo U('Admin/Attribute/index',array('type_id'=>I('get.type_id')));?>">属性列表</a>
                    </li>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo U('Admin/Attribute/add');?>" method="post">
                                        ...
                                        <div class="form-group">
                                           ...
                                           <div class="col-sm-2" style="margin-top:5px;">
                                                    <div class="radio">
                                                        <label>
                                                            <input name="attr_type" type="radio" checked="checked" value="唯一">
                                            ...
                                            <div class="col-sm-4" style="margin-top:5px;">
                                                <div class="radio">
                                                    <label>
                                                        <input name="attr_type" type="radio" value="可选">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                 <textarea class="form-control" rows='6' placeholder="多个值以，隔开" name="attr_option_values" type="text"></textarea>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <select name='type_id'>
                                                    <option>请选择</option>
                                                    <?php if(is_array($types)): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == I('get.type_id')): ?>selected<?php endif; ?>><?php echo ($vo["type_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
