...
<button type="button" tooltip="添加属性" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo U('Admin/Attribute/add',array('type_id'=>I('get.type_id','','intval')));?>'"> <i class="fa fa-plus"></i> 添加属性
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="ssss">
                            <tr>
                                ...
                                <th class="text-center">所属商品类型</th>
                        ...
                        <?php if(is_array($attrs)): $i = 0; $__LIST__ = $attrs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td align="center" style="width: 20%;"><?php echo ($vo["attr_name"]); ?></td>
                                <td align="center" style="width: 10%;"><?php echo ($vo["attr_type"]); ?></td>
                                <td align="center" style="width: 30%;"><?php echo ($vo["attr_option_values"]); ?></td>
                                <td align="center" style="width: 10%;"><?php echo ($vo["type_id"]); ?></td>
                                <td align="center" style="width: 20%;">
                                    <a href="<?php echo U('Admin/Attribute/edit',array('id'=>$vo['id']));?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="confirmJump('确实要删除吗', '<?php echo U('Admin/Attribute/del',array('id'=>$vo['id']));?>')" class="btn btn-danger btn-sm shiny">
