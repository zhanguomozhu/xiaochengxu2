                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">编辑轮播图图片</span>
                            </div>
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo U('Admin/Banner/edit');?>" method="post">
                                        <input type="hidden" name="id" value="<?php echo ($banner["id"]); ?>">
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">图片标题</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="若无标题则不填写" name="title" required="" type="text" value="<?php echo ($banner["title"]); ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input class="form-control" placeholder="上传后文件路径"  id="filepath" name="path" type="text" value="<?php echo ($banner["path"]); ?>">
                                            </div>
                                            <div class="col-sm-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                               <div style="width:100%;height:320px;border: 3px dashed #e6e6e6;padding: 5px 5px;" id='yulan'>
                                                <img src="<?php echo ($banner["path"]); ?>" width="100%" height="300">
                                               </div>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                               <select name="type">
                                                   <option value="1" <?php if($banner["type"] == 1): ?>selected<?php endif; ?>>头部轮播图</option>
                                                   <option value="2" <?php if($banner["type"] == 2): ?>selected<?php endif; ?>>中部广告位</option>
                                                   <option value="3" <?php if($banner["type"] == 3): ?>selected<?php endif; ?>>底部广告位</option>
                                               </select>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
