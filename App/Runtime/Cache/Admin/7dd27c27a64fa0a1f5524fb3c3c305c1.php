                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo U('Admin/Role/edit');?>" method="post">
                                        <input type="hidden" name="id" value="<?php echo ($role["id"]); ?>">
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">角色名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" name="name" required="" type="text" value="<?php echo ($role["name"]); ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" name="remark" required="" type="text" value="<?php echo ($role["remark"]); ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2" style="margin-top:5px;">
                                                    <div class="radio">
                                                        <label>
                                                            <input name="status" type="radio" value="1" <?php if($role["status"] == 1): ?>checked<?php endif; ?>>
                                            ...
                                            <div class="col-sm-4" style="margin-top:5px;">
                                                <div class="radio">
                                                    <label>
                                                        <input name="status" type="radio" value="0"  <?php if($role["status"] == 0): ?>checked<?php endif; ?>>
