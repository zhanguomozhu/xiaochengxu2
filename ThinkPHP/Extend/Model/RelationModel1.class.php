                                ...
                                case MANY_TO_MANY:
                                    ...
                                    switch (strtoupper($opType)){
                                        ...
                                        if(isset($relationId)) {
                                            ...
                                            //修改 start
                                            // $model11 = substr($mappingRelationTable,strlen(C('DB_PREFIX')));
                                            // //$thisModel = M($model);

                                            // M($model11)->where($mappingCondition)->delete();
                                        ...
                                        //修改 start
                                        // $model = substr($mappingRelationTable,strlen(C('DB_PREFIX')));
                                        // // //修改 end
                                        // $result =  M($model)->where($mappingCondition)->delete();
