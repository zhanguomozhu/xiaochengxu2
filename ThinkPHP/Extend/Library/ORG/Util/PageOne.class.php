...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>'条记录','prev'=>'上一页','next'=>'下一页','first'=>'首页','last'=>'末页','theme'=>'<li><a>共%totalRow% %header%</a></li> <li><a>%nowPage%/%totalPage% 页</a></li> %first% %upPage% %prePage%  %linkPage%  %downPage% %nextPage% %end%');
    // 默认分页变量名
    protected $varPage;
